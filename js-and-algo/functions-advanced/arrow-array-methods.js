...
people.forEach((person, index) => console.log(`${index}: ${JSON.stringify(person)}`));
...
const namesArr3 = people.map(person => person.fname + " " + person.lname);
